...
<form action="administrator/search" method="post">
	<p>
		Search user by userName: <input type="text" name="userName" />
		<button type="submit" name="command" value="search_user_by_userName">Search</button>
	</p>
</form>
<br>
...
<br>
<h3>
	Search result by UserName "<jsp:getProperty property="userName"
		name="search_user" />":
</h3>
<br>
